        ...
        <div className="container">
          ...
          <div>
            <p className="is-size-4 has-text-centered mb-5 has-text-weight-semibold">
              Hitech has the resources and knowledge to undertake just about any
              job.
            </p>
            <p className="has-text-centered">
              With projects, people, and technology, Hitech has unmatched reach
              and expertise. Hitech performs engineering, procurement ,
